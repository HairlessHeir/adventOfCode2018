...
def getGuard(timestamps):
	...
	for guardID in guards.keys():
		...
		print "{0} on {1} minute (for total {2} minutes)".format(guardID,sleepiestMinute,sleepiestMinuteTime)
		
		if sleepiestGuardMinuteTime < sleepiestMinuteTime:
			sleepiestGuardMinuteTime = sleepiestMinuteTime
			highestSleepTime = totalSleepTime
			sleepiestGuardMinute = sleepiestMinute
			sleepiestGuardID = guardID
	print "###"
	print "{0} on {1} minute (for total {2} minutes)".format(sleepiestGuardID,sleepiestGuardMinute,sleepiestGuardMinuteTime)
